...
import { ITransactionDetailsStates, TRANSACTION_DETIALS_INITIAL_STATE, transactionDetailsReducer } from './transaction-details-page/transaction-details-page.reducer';

export interface IAppState {
  transactions: ITransactionsState;
  details: IDetailsState;
  settings: ISettingsState;
  transaction_detail: ITransactionDetailsStates;
}
